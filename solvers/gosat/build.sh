...
BASE_TAG="dockeryangxu/base)_build:ubuntu1804"
FINAL_TAG="dockeryangxu/gosat_build:ubuntu1804"
...
DOCKER_BUILD_FILE="${SCRIPT_DIR}/gosat_build_ubuntu_18.04.Dockerfile"
