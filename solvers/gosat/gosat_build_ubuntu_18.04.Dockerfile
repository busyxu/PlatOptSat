...
# Install NLopt
RUN mkdir -p /home/user/nlopt
ADD /nlopt /home/user/nlopt
ADD /build_nlopt.sh /home/user/
RUN cd /home/user/ && ./build_nlopt.sh
...
ADD /gosat /home/user/gosat
ADD /gosat_build.sh /home/user/
RUN cd /home/user/ && ./gosat_build.sh
