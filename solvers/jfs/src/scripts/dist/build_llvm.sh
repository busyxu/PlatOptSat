...
LLVM_GIT_URL="${LLVM_GIT_URL:-http://github.com/llvm-mirror/llvm.git}"
CLANG_GIT_URL="${CLANG_GIT_URL:-http://github.com/llvm-mirror/clang.git}"
COMPILER_RT_GIT_URL="${COMPILER_RT_GIT_URL:-http://github.com/llvm-mirror/compiler-rt.git}"
LIBCXX_GIT_URL="${LIBCXX_GIT_URL:-http://github.com/llvm-mirror/libcxx.git}"
LIBCXXABI_GIT_URL="${LIBCXXABI_GIT_URL:-http://github.com/llvm-mirror/libcxxabi.git}"
