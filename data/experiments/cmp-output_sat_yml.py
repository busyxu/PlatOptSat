...
# 调用函数提取 benchmark
benchmarks = extract_benchmarks_with_different_sat('/home/aaa/PlatOptSat/data/experiments/runs/QF_FP_final/optsat/0/output_with_sat.yml', '/home/aaa/PlatOptSat/data/experiments/runs/QF_FP_final/ol1v3r/0/output_with_sat.yml')

# 保存提取出来的 benchmark 到 C.yml 文件
save_to_yaml(benchmarks, 'qf_fp-optsat-ol1v3r.yml')
